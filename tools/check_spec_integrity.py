...
for required in ['## 50. Authorship','<!-- COREDRP-SPEC-END:50 -->','https://github.com/NINJAK1DD/CoreDRP','https://coredrp.org','Draft 0.6']:
 if required not in s:die(f'missing sentinel {required}')
registries=['coredrp-mining-v1-semantics.md','coredrp-miningcore-v1-semantics.md','coredrp-v1-draft06-contracts.md','coredrp-v1-bitcoin-network-policies.md','coredrp-v1-admin-actions.md','coredrp-v1-metrics.md']
...
print('CoreDRP Draft 0.6 document structure: OK')
